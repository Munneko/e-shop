...
export default function CartPage() {
  ...
  const validPromo = "SALE25";
  const discountValue = 0.25;

  const handleApplyPromo = () => {
    if (promo.trim().toUpperCase() === validPromo) {
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="mb-6">
              <label
                htmlFor="promo"
                className="block text-base sm:text-lg text-gray-400 mb-2"
              >
                Promo Code (Use promo code {`"SALE25"`} to get 25% off!)
              </label>
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 hover:from-purple-600 hover:via-pink-600 hover:to-red-600 text-white font-bold text-base sm:text-lg p-4 sm:p-6 rounded-md shadow-xl transition-colors duration-300 ease-in-out w-full sm:w-auto"
                >
                  Apply
                </Button>
              </div>
